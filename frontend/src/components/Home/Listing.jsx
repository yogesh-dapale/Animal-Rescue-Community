...
import dogImage from '/HomeImages/AdoptDog.jpg'; // Add appropriate paths to your images
import catImage from '/HomeImages/AdoptCats.jpg';
import otherImage from '/HomeImages/AdoptOthers.jpg';
